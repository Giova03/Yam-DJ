...
@Component({
  ...
  standalone: true,
  imports: [RouterLink, TrackCardComponent, TipModalComponent, ShareModalComponent, IconComponent],
  template: `
    <div class="max-w-7xl mx-auto px-4 pt-6">
        ...
        <div class="flex flex-col md:flex-row items-start md:items-end gap-6">
          ...
          <div class="flex flex-col gap-3 shrink-0">
            ...
            @if (role() === 'DJ' || role() === 'ADMIN') {
              <a routerLink="/dj-studio" class="yam-btn-secondary !px-6 text-sm"> Studio DJ</a>
            }
      ...
      <section class="grid grid-cols-3 gap-4 mb-8">
        ...
        <div class="yam-card p-5 text-center">
          <p class="text-3xl mb-1"><yam-icon name="headphones" [size]="28"/></p>
      ...
      @if (tab() === 'aime') {
        ...
        <section>
          <h2 class="yam-title mb-1"> Tes coups de coeur</h2>
        ...
        <section>
          <h2 class="yam-title mb-6">⏱ Historique d'ecoute</h2>
          @if (loadingHistory()) {
            <div class="space-y-3">
            ...
            <div class="yam-card p-10 text-center">
              <div class="text-5xl mb-3"><yam-icon name="volume" [size]="28"/></div>
              ...
              @for (track of history(); track track) {
                <div class="yam-card p-3 flex items-center gap-4 group">
                  ...
                  <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-yam-orange/30 to-yam-gold/30 flex items-center justify-center shrink-0 overflow-hidden">
                    ...
                    } @else { <span class="text-xl opacity-50"><yam-icon name="music-note" [size]="28"/></span> }
                  </div>
                  ...
                  <button (click)="shareTrack.set(track)" class="text-white/40 hover:text-white transition shrink-0 text-sm" title="Partager la piste"><yam-icon name="share" [size]="28"/></button>
                  <button (click)="onPlay(track, history())"
                          ...
                          title="Ecouter"><yam-icon name="play" [size]="28"/></button>
                </div>
              }
            </div>
          }
        ...
        <section>
          <div class="flex items-center justify-between mb-6">
            <h2 class="yam-title"> Mes playlists</h2>
              ...
              @for (p of playlists(); track p.id) {
                <a [routerLink]="['/playlist', p.id]" class="yam-card p-4 group">
                  <div class="aspect-square rounded-xl mb-3 bg-gradient-to-br from-yam-orange/30 to-yam-surface flex items-center justify-center overflow-hidden">
                    ...
                    } @else { <span class="text-4xl opacity-60 group-hover:scale-110 transition"><yam-icon name="headphones" [size]="28"/></span> }
                  </div>
